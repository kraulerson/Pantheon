# CLAUDE.md — pantheon-harness

## Project Identity
- **Project:** pantheon-harness
- **Description:** Pantheon Harness: unified AI-orchestration harness for a single-operator homelab — LibreChat UI + Peta MCP gateway + custom control-plane (identity-as-session-profile, grounding/trusted:false pipeline, prompt-master, Obsidian MCP).
- **Platform:** web
- **Track:** standard
